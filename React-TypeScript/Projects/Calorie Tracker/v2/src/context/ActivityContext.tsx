...
import { activityReducer, initialState, type ActivityActions, type ActivityState } from "../reducer/activityReducer";
...
type ActivityContextProps = {
    ...
    netCalories: number,
    categoryName: (category: number) => (string | null)[],
    isEmptyActivities: boolean
}

export const ActivityContext = createContext<ActivityContextProps>(null!)

export const ActivityProvider = ({children} : ActivityProvider) => {
    ...
    (category : Activity['category']) => categories.map(cat => cat.id === category ? cat.name : null), [state.activities])
