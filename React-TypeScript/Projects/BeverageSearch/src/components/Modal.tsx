...
export default function Modal() {
    ...
    const { selectedRecipe, modal, closeModal, handleClickFavorite, favoriteExists } = useAppStore()
    ...
    return (
        <>
            <Transition appear show={modal} as={Fragment}>
                <Dialog as="div" className="relative z-10 max-h-[80vh]" onClose={closeModal}>
                    <Transition.Child
                        as={Fragment}
                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel
                                    ...
                                    "
                                >
                                    <Dialog.Title as="h3" className="text-gray-900 text-4xl font-extrabold mt-1 mb-4 text-center">
                                        {selectedRecipe.strDrink}
                                    </Dialog.Title>
                                    <img 
                                        src={selectedRecipe.strDrinkThumb} 
                                        alt={`Img of ${selectedRecipe.strDrink}`}
